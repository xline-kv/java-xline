/*
 * Copyright 2016-2021 The jxline authors
 *
...
import cloud.xline.jxline.impl.ClientImpl;
...
/**
 * Xline client builder, Copied from jxline.cloud.xline.client.ClientBuilder, but build the
 * implementation of xline client
 */
public final class ClientBuilder implements Cloneable {
    ...
    /**
     * Gets the xline target.
     *
     * @return the xline target.
     */
    ...
    /**
     * configure xline server endpoints.
     *
     * @param target xline server target
    ...
    public ClientBuilder target(String target) {
        Preconditions.checkArgument(
                !Strings.isNullOrEmpty(target), "target can't be null or empty");
    ...
    /**
     * configure xline server endpoints using the {@link IPNameResolver}.
     *
     * @param endpoints xline server endpoints, at least one
     * @return this builder to train
    ...
    public ClientBuilder endpoints(String... endpoints) {
        return endpoints(Stream.of(endpoints).map(URI::create).toArray(URI[]::new));
    }
    ...
    public ClientBuilder endpoints(Iterable<URI> endpoints) {
                ...
                e -> {
                    if (e.getHost() == null) {
                        throw new IllegalArgumentException(
                                "Unable to compute target from endpoint: '" + e + "'");
                    }
                });
        ...
        if (Strings.isNullOrEmpty(target)) {
            throw new IllegalArgumentException(
                    "Unable to compute target from endpoints: '" + endpoints + "'");
        }
    ...
    /**
     * config xline auth user.
     *
     * @param user xline auth user
     * @return this builder
    ...
    /**
     * config xline auth password.
     *
     * @param password xline auth password
     * @return this builder
     ...
     *
     * @param loadBalancerPolicy xline load balancer policy
     * @return this builder
    ...
    /**
     * get the load balancer policy for xline client.
     *
    ...
    /**
     * SSL/TLS context to use instead of the system default. It must have been configured with
     * {@link GrpcSslContexts}, but options could have been overridden.
     *
    ...
    public Map<Metadata.Key<?>, Object> authHeaders() {
        return authHeaders == null
                ...
                : Collections.unmodifiableMap(authHeaders);
    }
     ...
     * @return this builder
     */
    public ClientBuilder interceptor(
            ClientInterceptor interceptor, ClientInterceptor... interceptors) {
     ...
     * @return this builder
     */
    public ClientBuilder authInterceptors(
            ClientInterceptor interceptor, ClientInterceptor... interceptors) {
     ...
     *
     * @param connectTimeout Sets the connection timeout. Clients connecting to fault tolerant xline
     *     clusters (eg, clusters with more than 2 xline server peers/endpoints) should consider a
     *     value that will allow switching timely from a crashed/partitioned peer to a consensus
     *     peer.
     * @return this builder
     */
    public ClientBuilder connectTimeout(Duration connectTimeout) {
        if (connectTimeout != null) {
            ...
            if ((int) millis != millis) {
                throw new IllegalArgumentException(
                        "connectTimeout outside of its bounds, max value: " + Integer.MAX_VALUE);
            }
        }
     ...
     * @see <a href="https://github.com/grpc/grpc/blob/master/doc/wait-for-ready.md">gRPC Wait for
     *     Ready Semantics</a>
     */
     ...
     *
     * @param waitForReady if this client should use gRPC's wait for ready semantics. Enabled by
     *     default.
     * @return this builder.
     * @see <a href="https://github.com/grpc/grpc/blob/master/doc/wait-for-ready.md">gRPC Wait for
     *     Ready Semantics</a>
    ...
    /**
     * build a new cloud.xline.client.Client.
     *
     * @return cloud.xline.client.Client instance.
     * @throws RuntimeException if client experiences build error.
     */
    public Client build() {
        Preconditions.checkState(
                target != null, "please configure xline server endpoints before build.");
    ...
    public ClientBuilder copy() {
        try {
            ...
            throw new RuntimeException("client builder not cloneable");
        }
    }
}
