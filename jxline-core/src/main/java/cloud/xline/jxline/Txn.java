...
public interface Txn {
    // CHECKSTYLE:OFF
    /**
     * takes a list of comparison. If all comparisons passed in succeed, the operations passed into
     * Then() will be executed. Or the operations passed into Else() will be executed.
     *
    ...
    // CHECKSTYLE:OFF
    /**
     * takes a list of operations. The Ops list will be executed, if the comparisons passed in If()
     * succeed.
     *
